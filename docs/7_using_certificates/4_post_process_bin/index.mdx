---
sidebar_position: 4
description: 'LeGo CertHub can run a binary after each certificate renewal.'
---

# Post Processing Script / Binary

LeGo CertHub can execute a script or binary after each certificate renewal. To
...
LeGo CertHub automatically deduces if the specified file is a binary or script.
